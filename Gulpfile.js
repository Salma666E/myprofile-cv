...
function jsMinify() {
    return src('js/**/*.js') //path includeing all js files in all folders
...
function sassMinify() {
    return src(["sass/**/*.scss", "src/css/**/*.css"])
...
//watch task
function watchTask() {
    watch(['js/**/*.js', "css/**/*.css"], { interval: 1000 }, parallel(jsMinify, sassMinify));
}
